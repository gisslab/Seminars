...
\begin{equation}
    ...
    \begin{itemize}
        \item $R_{D,nmt}$, $R_{M,nmt}$, $R_{L,nmt}$ are deposit, mortgages, and loan rates in market $n$ at time $t$.
        \item $R_{S,t}$ is the security rate in the competitive market. 
        \item $R^{D,m}_t$, $R^{L,m}_t$, $R^{S,m}_t$ are the cash flows discount rates of the deposits, mortgages, loans, and securities.
