...
\begin{frame}{Model: Supply}
    ...
    $$
    \begin{aligned}
    \overbrace{\frac{\partial}{\partial R_{j, nm t}}\left[Q_{j, nm t}\left(R_t^{j, m}-R_{j, nm t}\right)\right]}^{\text {Marginal Revenue }} & =\overbrace{\frac{\partial C\left(\Theta_{m t}\right)}{\partial Q_{X, n m t}} \frac{\partial Q_{j, nm t}}{\partial R_{j, nm t}}}^{\text {Marginal Cost }}, \quad j \in \{D,L,M\} \\
    ...
    \underbrace{R_{S, t}-R_t^{S, m}}{\text{Reserve spread}} & =\frac{\partial C\left(\Theta_{m t}\right)}{\partial Q_{S, m t}} .
    \end{aligned}
    $$
