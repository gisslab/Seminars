...
\begin{frame}{Model}
    ...
    \frac{\partial}{\partial R_{M, n m t}}\left[Q_{M, n m t}\left(R_{M, n m t}-R_t^{M, m}\right)\right] & =\frac{\partial C\left(\Theta_{m t}\right)}{\partial Q_{M, n m t}} \frac{\partial Q_{M, n m t}}{\partial R_{M, n m t}}, j \in \{ L,M\} \} \\
