...
\begin{frame}{Model}
    ...
    \frac{\partial}{\partial R_{j, n m t}}\left[Q_{j, n m t}\left(R_{j, n m t}-R_t^{j, m}\right)\right] & =\frac{\partial C\left(\Theta_{m t}\right)}{\partial Q_{j, n m t}} \frac{\partial Q_{j, n m t}}{\partial R_{j, n m t}}, j \in \{ L,M\} \} \\
