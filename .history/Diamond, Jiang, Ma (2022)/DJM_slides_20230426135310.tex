...
\frac{\partial\left(R_t^{M, m}-R_{M, n m t}-\frac{Q_{M, n m t}}{\partial Q_{M, n m t} / \partial R_{M, n m t}}\right)}{\partial Q_{M, n m t}} \frac{\partial Q_{M, n m t}}{\partial Q_{S, m t}} & =-\frac{\partial^2 C\left(\Theta_{m t}\right)}{\partial Q_{M, n m t} \partial \Theta_{m t}} \cdot \frac{\partial \Theta_{m t}}{\partial Q_{S, m t}} \\
