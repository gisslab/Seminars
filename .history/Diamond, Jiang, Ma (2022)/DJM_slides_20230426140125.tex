...
\end{aligned}
$$
 where $\frac{\partial Q_{j, n m t}}{\partial Q_{S, m t}}$ is the response of each quantity of $j \in \{D,L,M \}$ to a change in $Q_{S, m t}$, and $\frac{\partial \Theta_{m t}}{\partial Q_{S, m t}}$ is the response of the balance sheet costs to a change in $Q_{S, m t}$.
\end{frame}
