...
\begin{wideitemize}
\item The impact of reserve supplt on bank lending is ambiguous: 
\begin{itemize}
    \item[\uparrow] lending: add to the cost of meeting capital requirements when equity is scarce, reduce costs of sellins illiquid assets in a bank run. 
    \item[\downarrow] lending, bank leverage constraints can make it costly to expand asset holding.   
\end{itemize}
\end{wideitemize}
