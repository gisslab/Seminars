...
\begin{itemize}
    \item[$\uparrow$] \textit{lending:} add to the cost of meeting capital requirements when equity is scarce, reduce costs of sellins illiquid assets in a bank run. 
    \item[$\downarrow$] \textit{lending}, bank leverage constraints can make it costly to expand asset holding.   
\end{itemize}
