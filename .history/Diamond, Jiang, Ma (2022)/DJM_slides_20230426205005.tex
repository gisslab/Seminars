...
\begin{wideitemize}
\item The impact of reserve supply on bank lending is ambiguous: 

\begin{itemize}
    \item[$\uparrow$] \textit{lending:} reduce costs of selling illiquid assets in a bank run help comply with liquidity regulations.  
    \item[$\downarrow$] \textit{lending} add to the cost of meeting capital requirements when equity is scarce, bank leverage constraints can make it costly to expand asset holding.   
\end{itemize}
