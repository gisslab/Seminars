...
\begin{wideitemize}
    ...
    \item[$\downarrow$] \textit{lending:} \\ Add to the cost of meeting capital requirements when equity is scarce, reserves  may amplify liquidity strains during stress spisodes (Acharya and Rajan, 2021)
    %bank leverage constraints can make it costly to expand asset holding    
\end{wideitemize}
