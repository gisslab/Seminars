...
\begin{wideitemize}
    ...
    \item[$\downarrow$] \textit{lending:} \\ Add to the cost of meeting capital requirements when equity is scarce (Kashyap and Stein 1993), reserves  may amplify liquidity strains during stress spisodes (Acharya and Rajan, 2021), bank leverage constraints can make it costly to expand asset holding (Du, Tepper, and Verdelhan, 2018)    
\end{wideitemize}
