...
\begin{frame}{Model}
    \vspace{0.5cm}
      \begin{itemize}
        \item Banks' holding if liquid reserve may impact their marginal cost of lending. 
...
$$
- $N_{m t}^u$ : number of unaffected branches of bank $m$
- damage $e_{n^{\prime} t}$ : property loss in market $n^{\prime}$
- $\frac{Q_{D, n^{\prime} m t}}{\sum_{n_0} Q_{D, n_0 m t}}$ : fraction of deposits belonging to branches of bank $m$ in affected markets
