      ...
      \begin{frame}{Demand system}
        \vspace{0.5cm}
          \begin{itemize}
            ...
            \item Includes market characteristics like the average age, average income, the share of residents with a college degree,
            log population, growth of house prices, log property damage due to natural disasters, and lagged
            quantities as county-level control variables.
          \end{itemize}
