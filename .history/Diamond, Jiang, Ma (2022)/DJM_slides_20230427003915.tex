      ...
      \begin{frame}{Demand system}
        \vspace{0.5cm}
          \begin{itemize}
            ...
            \item Includes county-level control variables like the average age, average income, the share of residents with a college degree,
            log population, growth of house prices, log property damage due to natural disasters, and lagged
            quantities.

                       % \hyperlink{firststage}{\beamergotobutton{First Stage Estimates}}
                       \item equation (A22), the increase in deposit quantity when all banks in a county raise their deposit rates by 10 basis points is given by
                       $$
