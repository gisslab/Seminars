...
\begin{frame}{Counterfactuals}
    \vspace{0.5cm}
      \begin{itemize}
        ...
        \item Average interest rates on deposits, mortgages, and loans increase by
        12.7 bps, 18.8 bps, and 15.6 bps.
        \item  Reserve supply and Reduction in Corporate Loan Issuance (estimated impact in bank loan quantities).
      \end{itemize}
      
        \begin{figure}[t*]
          \centering
    
          \includegraphics[width=.45\textwidth]{./imgs/counterf_figure.png}
        % \caption{Supply of Central Banks Reserves and Bank Asset Illiquidity}
        \end{figure}
